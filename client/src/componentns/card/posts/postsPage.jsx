...
const PostsPage =()=>{
  ...
  //const postIndex = useSelector(store => store.cardIndex.value)
...
const products2 = productsArr[userIndex].posts
...
//<button  onClick ={() =>{dispatch(incrementLikesAC({index:index,userIndex:userIndex}))
